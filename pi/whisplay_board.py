"""Vendored WhisplayBoard driver — PiSugar WhisPlay HAT (Apache-2.0).

Source: https://github.com/PiSugar/WhisPlay (runtime/whisplay.py), used under
Apache License 2.0. Correct pin mapping for Raspberry Pi 5 (gpiochip4/RP1):
  DC  = BOARD 13 -> GPIO11
  RST = BOARD 7  -> GPIO4
  LED = BOARD 15 -> GPIO22 (backlight, active LOW)
  BTN = BOARD 11 -> GPIO17 (pressed = HIGH, external pull-down)
RGB LED: RED=GPIO25 GREEN=GPIO24 BLUE=GPIO23. Display: 240x280 RGB565, SPI0.
"""
