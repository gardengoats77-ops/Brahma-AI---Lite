...
def should_extract_memory(user_text: str, rex_text: str, api_key: str = "") -> bool:
    try:
...
def extract_memory(user_text: str, rex_text: str, api_key: str = "") -> dict:
    try:
        from or_client import client
        ...
        raw = client.chat(
            ...
            f"                  (e.g. mark_xxv: 'Building a REX assistant')\n"
            ...
            f"- Extract from BOTH user and REX turns.\n"
            ...
            f' "projects":{{"mark_xxv":{{"value":"REX assistant"}}}},\n'
