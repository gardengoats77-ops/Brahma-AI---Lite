...
def should_extract_memory(user_text: str, almighty_text: str, api_key: str = "") -> bool:
    try:
        from or_client import client

        combined = f"User: {user_text[:300]}\nRex: {almighty_text[:1000]}"
...
def extract_memory(user_text: str, almighty_text: str, api_key: str = "") -> dict:
    try:
        from or_client import client

        combined = f"User: {user_text[:600]}\nRex: {almighty_text[:300]}"
        ...
        raw = client.chat(
            ...
            f"                  (e.g. mark_xxv: 'Building a Almighty AI assistant')\n"
            ...
            f"- Extract from BOTH user and Almighty AI turns.\n"
            ...
            f' "projects":{{"mark_xxv":{{"value":"Almighty AI assistant"}}}},\n'
