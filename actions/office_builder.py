"""
office_builder.py - Almighty AI office document generation
...
DEFAULT_OUTPUT_DIR = Path.home() / "Desktop" / "AlmightyAI"
...
def _resolve_output_path(output_path: str | None, title: str, ext: str) -> Path:
    ...
    return DEFAULT_OUTPUT_DIR / f"{_sanitize_filename(title, 'almighty_ai_output')}{ext}"
